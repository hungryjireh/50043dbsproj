...
# csv_data = spark.read.csv("hdfs://ec2-34-239-131-131.compute-1.amazonaws.com:9000/kindle_reviews.csv",inferSchema=True, header=True)
...
# tf = CountVectorizer(inputCol="words", outputCol="tf", vocabSize=2**8)
# tf = HashingTF(numFeatures=2**6, inputCol="words", outputCol='tf')
...
# sc.textFile("hdfs://ec2-34-239-131-131.compute-1.amazonaws.com:9000/output7/part*").coalesce(1).saveAsTextFile("hdfs://ec2-34-239-131-131.compute-1.amazonaws.com:9000/output7/final_output.txt")
